...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <meta name="google-site-verification" content="hnX54HYUQ7M53VbL8Nycoi2LcVT1OWf34-cXMg43jS8" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              hasMap: `https://maps.google.com/?q=${encodeURIComponent("Sai shree polyclinic Cuttack At- Kathagola, Ring Rd, near Shree Maa Hospital, Cuttack, Odisha 753110 ")}`,
              aggregateRating: {
