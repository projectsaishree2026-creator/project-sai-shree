...
export function WhatsAppButton() {
  const url = getWhatsAppUrl(`Hello ${clinic.name}, I'd like to book an appointment.`);
  return (
    <a
      href={url}
      target="_blank"
      ...
      className="fixed bottom-24 md:bottom-6 right-5 z-50 w-14 h-14 rounded-full flex items-center justify-center animate-whatsapp shadow-xl"
